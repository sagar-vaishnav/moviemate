    ...
    <main>
      <section className="flex flex-wrap justify-around py-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg	 dark:text-white">
          <h1 className="text-4xl font-bold text-gray-700 my-3 dark:text-white text-center lg:text-left">{movie.original_title}</h1>
          ...
          <p className="my-4"><span className="mr-2 font-bold">Runtime:</span>{movie.runtime}<span> min.</span></p>
          ...
          <p className="my-4"><span className="mr-2 font-bold">IMDB Code:</span><Link to={`https://www.imdb.com/title/${movie.imdb_id}/`} target="_blank" rel="noreferrer" >{movie.imdb_id}</Link></p>
        </div>
      </section>
    </main>
  )
